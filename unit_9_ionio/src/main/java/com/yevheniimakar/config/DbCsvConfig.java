...
public class DbCsvConfig<E> {
    ...
    public static final String STUDENT_DB = "student.csv";
    public static final String COURSE_DB = "student.csv";
    public static final String STUDENT_COURSE_DB = "student.csv";
    public static final String ID_COUNT = "student.csv";
    public static final String[] STUDENT_HEAD = {"id", "name"};
    public static final String[] COURSE_HEAD = {"id", "name"};
    public static final String[] STUDENT_COURSE_HEAD = {"student_id", "course_id"};
    public static final String[] ID_COUNT_HEAD = {"student_increment", "course_increment"};
